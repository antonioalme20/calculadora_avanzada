...
def main():
	...
	if eleccion1 == '5':
		...
		if eleccion_n == '1':
			...
			print("Pon la primera nota")
			nota1=float(input())
			print("Pon la segunda nota")
			nota2=float(input())
			def notas2():
	...
	if eleccion1 == '6':
		...
		if eleccionv=='3':
			...
			x1=float(input())
			print("Coordenada 2 del origen")
			y1=float(input())
			print("\nCoordenada 1 del extremo")
			x2=float(input())
			print("Coordenada 2 del extremo")
			y2=float(input())
			def vector():
				v1=str(x2-x1)
				v2=str(y2-x1)
